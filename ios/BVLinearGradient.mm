...
#import <react/renderer/components/BVLinearGradientSpec/ComponentDescriptors.h>
#import <react/renderer/components/BVLinearGradientSpec/EventEmitters.h>
#import <react/renderer/components/BVLinearGradientSpec/Props.h>
#import <react/renderer/components/BVLinearGradientSpec/RCTComponentViewHelpers.h>
...
@interface BVLinearGradient () <RCTBVLinearGradientViewProtocol>
...
{
    return concreteComponentDescriptorProvider<BVLinearGradientComponentDescriptor>();
}

- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        static const auto defaultProps = std::make_shared<const BVLinearGradientProps>();
        _props = defaultProps;
    }
...
{
    const auto &oldViewProps = *std::static_pointer_cast<BVLinearGradientProps const>(_props);
    const auto &newViewProps = *std::static_pointer_cast<BVLinearGradientProps const>(props);
...
Class<RCTComponentViewProtocol> BVLinearGradientCls(void)
{
    return BVLinearGradient.class;
}
